...
namespace Hazel {
	...
	void Renderer2D::DrawQuad(const glm::vec2& position, const glm::vec2& size, float rotation, const Ref<Texture2D>& texture, float repeatCount, const glm::vec4& tintColor)
	{
		DrawQuad({ position.x, position.y, 0.0f }, size, rotation, texture, repeatCount, tintColor);
	}

	void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, float rotation, const Ref<Texture2D>& texture, float repeatCount, const glm::vec4& tintColor)
	{
		HZ_PROFILE_FUNCTION();
		...
		DrawQuad(transform, texture, repeatCount, tintColor);
	}
	...
	void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, float rotation, const Ref<SubTexture2D>& subTexture, float repeatCount, const glm::vec4& tintColor)
	{
		...
		DrawQuad(transform, subTexture, repeatCount, tintColor);
	}
	...
	void Renderer2D::DrawQuad(const glm::mat4& transform, const Ref<Texture2D>& texture, float repeatCount, const glm::vec4& tintColor, int entityID)
	{
		HZ_PROFILE_FUNCTION();
	...
	void Renderer2D::DrawQuad(const glm::mat4& transform, const Ref<SubTexture2D>& subTexture, float repeatCount, const glm::vec4& tintColor, int entityID)
	{
		HZ_PROFILE_FUNCTION();
